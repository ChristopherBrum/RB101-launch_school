...
# new array created 'customer_orders'
# each hash contains 3 key/value pairs: customer_id, customer_name, orders
  # the orders key points to an array as a value
    # within each array is key/value pairs for each order_fulfilled and order_value
...
p fulfilled_orders
p fulfilled_orders == corrrect_fulfilled_orders